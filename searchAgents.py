...
# 距离度量：distan(p1, p1)
# manhattan, euclidean O(1)
# manhattanWall:考虑了两点之间的墙的最小距离 O(n)
# mazeDistance:在迷宫中的最短路径 O(2^n)

# h(n) = 所有点的距离最近的点的距离之和 - 最近距离中的最大值 + 当前位置到最近点的距离
...
def foodHeuristic_closest_euclidean(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
...
# h(n) = 与当前位置距离最远的点的距离
def foodHeuristic_farthest_manhattan(state, problem):
    ...
    if not food_coordinates:
        return 0
    farthest = max(map(lambda  x: distan(x, position), food_coordinates))
    return farthest

def foodHeuristic_farthest_euclidean(state, problem):
    def distan(p1, p2):
...
def foodHeuristic_farthest_manhattanWall(state, problem):
...
def foodHeuristic_farthest_mazeDistance(state, problem):
    position, foodGrid = state
    food_coordinates = foodGrid.asList()
    if not food_coordinates:
        return 0
...
# h(n) = 通过任意两点所需的最小距离中的最大值
def foodHeuristic_farthest2_manhattanWall(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
    ...
    for food in food_list:
        for other_food in food_list:
            if food == other_food:
                continue
            distance = distan(food, other_food) + min(distan(food, position), distan(other_food, position))
    ...
    if len(food_list) >= 2:
        ...
        return distan(food_A, food_B) + min(distan(food_A, position), distan(food_B, position))
    elif len(food_list) == 1:
        return distan(position, food_list[0])
    else:
        return 0

def foodHeuristic_farthest2_manhattan(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
...
def foodHeuristic_farthest2_euclidean(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
...
def foodHeuristic_farthest2_mazeDistance(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
...
# h(n) = 通过任意三点所需的最小距离中的最大值
def foodHeuristic_manhattanWall(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
        ...
        for food in food_list:
            for second_food in food_list:
                for third_food in food_list:
                    ...
                    d = min(value1, value2, value3, value4, value5, value6)
                    if d > max_distance:
                        max_distance = d

        return max_distance

def foodHeuristic_farthest3_manhattan(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
...
def foodHeuristic_farthest3_euclidean(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
...
def foodHeuristic_farthest3_mazeDistance(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
...
# h(n) = 通过任意四点所需的最小距离中的最大值
def foodHeuristic_farthest4_manhattanWall(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
    This heuristic must be consistent to ensure correctness.  First, try to come
    up with an admissible heuristic; almost all admissible heuristics will be
            ...
            for food_second in food_list:
                for food_third in food_list:
                    for food_forth in food_list:
                        ...
                        #
                        # dp1 = distan(position, food_first)
                        # dp2 = distan(position, food_second)
                        # dp3 = distan(position, food_third)
                        # dp4 = distan(position, food_forth)
                        # d_total = d12 + d13 + d14 + d23 + d24 + d34 + dp1 + dp2 + dp3 + dp4
                        ...
                        d_total = min(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22,
                   v23, v24)
...
def foodHeuristic_farthest4_manhattan(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
    This heuristic must be consistent to ensure correctness.  First, try to come
    up with an admissible heuristic; almost all admissible heuristics will be
...
def foodHeuristic_farthest4_euclidean(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
    This heuristic must be consistent to ensure correctness.  First, try to come
    up with an admissible heuristic; almost all admissible heuristics will be
...
def foodHeuristic_farthest4_mazeDistance(state, problem):
    """
    Your heuristic for the FoodSearchProblem goes here.
    This heuristic must be consistent to ensure correctness.  First, try to come
    up with an admissible heuristic; almost all admissible heuristics will be
...
# foodHeuristic_farthest2_manhattanWall
